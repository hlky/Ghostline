...
ONSCREEN_RAW = ROOT / "source/raw/mod/gq002/localization/en-us/onscreens/gq002.json.json"
ONSCREEN_ARCHIVE = ROOT / "source/archive/mod/gq002/localization/en-us/onscreens/gq002.json"
...
def make_message(handles: Handles, template: dict[str, Any], entry_id: str, text_key: str) -> dict[str, Any]:
...
def make_choice(handles: Handles, template: dict[str, Any], entry_id: str, text_key: str) -> dict[str, Any]:
    result = handles.clone(template)
    result["Data"]["id"] = entry_id
    set_loc(result["Data"], "text", text_key)
    return result
...
def generate_journal() -> dict[str, Any]:
    ...
    objective_template = find_entry(journal, "gameJournalQuestObjective", "gq001_01_obj_meet_patch")

    quest["Data"]["id"] = "gq002"
    set_loc(quest["Data"], "title", "gl_gq002_title")
    phase_specs = [
        ("gq002_01", "gq002_01_obj_meet_cinder", "meet_cinder", [("gq002_01_qmp_cinder", "cinder", "#gq002_01_mp_cinder")]),
        ("gq002_02", "gq002_02_obj_reach_relay", "reach_relay", [("gq002_02_qmp_relay", "relay", "#gq002_02_mp_relay")]),
        (
            "gq002_03",
        ...
        ("gq002_05", "gq002_05_obj_clear_security", "clear_security", [("gq002_05_qmp_security", "security", "#gq002_02_mp_relay")]),
        ("gq002_06", "gq002_06_obj_operate_relay", "operate_relay", [("gq002_06_qmp_relay", "operate", "#gq002_02_mp_relay")]),
    ...
    conversation_template = find_entry(journal, "gameJournalPhoneConversation", "gq001_05_delivery")
    message_template = find_entry(journal, "gameJournalPhoneMessage", "01_msg_cache_authenticated")
    choice_group_template = find_entry(journal, "gameJournalPhoneChoiceGroup", "03_ch_delivery_response")
    choice_template = find_entry(journal, "gameJournalPhoneChoiceEntry", "03a_ch_pay_me")
    ...
    patch["Data"]["entries"] = [
        make_conversation(
            ...
            [
                make_message(handles, message_template, "01_msg_cinder", "gl_gq002_phone_msg_cinder"),
                make_choice_group(
                    handles,
                    choice_group_template,
                    "02_ch_meet_cinder",
                    [make_choice(handles, choice_template, "02a_ch_on_my_way", "gl_gq002_phone_choice_on_my_way")],
                ),
            ],
        )
    ]
    ...
    relay_entries = [
        make_message(handles, message_template, "01_msg_hostage_circuit", "gl_gq002_phone_relay_hostage"),
        make_message(handles, message_template, "02_msg_choose", "gl_gq002_phone_relay_choose"),
        make_choice_group(
            handles,
            choice_group_template,
            "03_ch_response",
            [
                make_choice(handles, choice_template, "03a_ch_destroy", "gl_gq002_phone_choice_destroy"),
                make_choice(handles, choice_template, "03b_ch_spoof", "gl_gq002_phone_choice_spoof"),
            ],
        ),
        make_message(handles, message_template, "04a_msg_destroy", "gl_gq002_phone_relay_destroy_reply"),
        make_message(handles, message_template, "04b_msg_spoof", "gl_gq002_phone_relay_spoof_reply"),
        make_message(handles, message_template, "05_msg_proceed", "gl_gq002_phone_relay_proceed"),
    ]
    debrief_entries = [
        make_message(handles, message_template, "01_msg_outcome", "gl_gq002_phone_debrief_outcome"),
        make_message(handles, message_template, "02_msg_context", "gl_gq002_phone_debrief_context"),
        make_message(handles, message_template, "02a_msg_destroy_confirm", "gl_gq002_phone_debrief_destroy_confirm"),
        make_message(handles, message_template, "02b_msg_spoof_confirm", "gl_gq002_phone_debrief_spoof_confirm"),
        make_choice_group(
            handles,
            choice_group_template,
            "03_ch_response",
            [
                make_choice(handles, choice_template, "03a_ch_hard", "gl_gq002_phone_choice_hard"),
                make_choice(handles, choice_template, "03b_ch_careful", "gl_gq002_phone_choice_careful"),
            ],
        ),
        make_message(handles, message_template, "04a_msg_hard", "gl_gq002_phone_debrief_hard_reply"),
        make_message(handles, message_template, "04b_msg_careful", "gl_gq002_phone_debrief_careful_reply"),
        make_message(handles, message_template, "05_msg_more_work", "gl_gq002_phone_debrief_more_work"),
    ]
    cinder["Data"]["entries"] = [
        make_conversation(handles, conversation_template, "gq002_06_relay_decision", "gl_gq002_phone_relay_title", relay_entries),
        make_conversation(handles, conversation_template, "gq002_08_debrief", "gl_gq002_phone_debrief_title", debrief_entries),
    ]
    ...
    poi = find_entry(journal, "gameJournalPointOfInterestMappin", "gq001_01_poi_patch_bridge")
...
def main() -> int:
    ...
    parser.add_argument("--deserialize", action="store_true", help="Also create packed CR2W resources.")
