...
LAPTOP_TEMPLATE = (
    ROOT / "source/raw/mod/gqt001/world/gqt001_laptop_instance.streamingsector.json"
)
...
ROOT_PHASE_TEMPLATE = (
    ROOT / "source/archive/mod/gqt002/phases" / "gqt002_quiet_install.questphase"
)
QUEST_SECTOR_TEMPLATE = (
    ROOT / "source/archive/mod/gq002/world/gq002_machine_stops.streamingsector"
)
ALWAYS_SECTOR_TEMPLATE = (
    ROOT / "source/archive/mod/gqt003/world/gqt003_always_loaded.streamingsector"
)
DEVICE_REGISTRY_TEMPLATE = (
    ROOT / "source/archive/mod/gqt001/world/gqt001_custom_devices.devices"
)
SECURITY_NODE_REFERENCE = (
    ROOT / "reference/world/ambient-terminals/exterior_-18_28_0_0.streamingsector.json"
)
WORLD_SPEC = ROOT / "quests/tests/gqt002/implementation/world/quiet-install.world.json"
...
ONSCREEN_RAW = (
    ROOT / "source/raw/mod/gqt002/localization/en-us/onscreens/gqt002.json.json"
)
ONSCREEN_ARCHIVE = (
    ROOT / "source/archive/mod/gqt002/localization/en-us/onscreens/gqt002.json"
)
PLANT_TEMPLATE_RAW = (
    ROOT / "source/raw/mod/gqt002/templates/gqt002_guarded_plant.questphase.json"
)
PLANT_TEMPLATE_ARCHIVE = (
    ROOT / "source/archive/mod/gqt002/templates/gqt002_guarded_plant.questphase"
)
DETECT_RAW = ROOT / "source/raw/mod/gqt002/phases/gqt002_detect_guards.questphase.json"
DETECT_ARCHIVE = (
    ROOT / "source/archive/mod/gqt002/phases/gqt002_detect_guards.questphase"
)
...
LAPTOP_RAW = (
    ROOT / "source/raw/mod/gqt002/world/gqt002_laptop_instance.streamingsector.json"
)
LAPTOP_ARCHIVE = (
    ROOT / "source/archive/mod/gqt002/world/gqt002_laptop_instance.streamingsector"
)
BLOCK_RAW = (
    ROOT / "source/raw/mod/gqt002/world/gqt002_quiet_install.streamingblock.json"
)
BLOCK_ARCHIVE = (
    ROOT / "source/archive/mod/gqt002/world/gqt002_quiet_install.streamingblock"
)
DEVICE_REGISTRY_RAW = (
    ROOT / "source/raw/mod/gqt002/world/gqt002_custom_devices.devices.json"
)
DEVICE_REGISTRY_ARCHIVE = (
    ROOT / "source/archive/mod/gqt002/world/gqt002_custom_devices.devices"
)
QUEST_SECTOR_RAW = (
    ROOT / "source/raw/mod/gqt002/world/gqt002_quiet_install.streamingsector.json"
)
QUEST_SECTOR_ARCHIVE = (
    ROOT / "source/archive/mod/gqt002/world/gqt002_quiet_install.streamingsector"
)
ALWAYS_SECTOR_RAW = (
    ROOT / "source/raw/mod/gqt002/world/gqt002_always_loaded.streamingsector.json"
)
ALWAYS_SECTOR_ARCHIVE = (
    ROOT / "source/archive/mod/gqt002/world/gqt002_always_loaded.streamingsector"
)
SECURITY_SECTOR_RAW = (
    ROOT / "source/raw/mod/gqt002/world/gqt002_security.streamingsector.json"
)
SECURITY_SECTOR_ARCHIVE = (
    ROOT / "source/archive/mod/gqt002/world/gqt002_security.streamingsector"
)
...
def phase_document(
    builder: PhaseGraphBuilder, archive: Path, *, prefab: bool = False
) -> dict[str, Any]:
    return {
        "Header": {
...
def generate_journal() -> dict[str, Any]:
    ...
    for index, suffix, optional, marker in objectives:
        ...
        objective["Data"]["description"] = loc(f"gl_gqt002_0{index}_objective_{suffix}")
...
def generate_root_phase() -> dict[str, Any]:
    ...
    detector = phase_node(
        builder, 19, r"mod\gqt002\phases\gqt002_detect_guards.questphase"
    )
    monitor = phase_node(
        builder, 20, r"mod\gqt002\phases\gqt002_remain_undetected.questphase"
    )
    plant = phase_node(
        builder, 21, r"mod\gqt002\phases\gqt002_plant_keylogger.questphase"
    )
...
def main() -> int:
    ...
    outputs = (
        ...
        (
            ...
            QUEST_SECTOR_ARCHIVE,
            QUEST_SECTOR_TEMPLATE,
            load(QUEST_SECTOR_RAW),
        ),
        (
            ALWAYS_SECTOR_RAW,
            ALWAYS_SECTOR_ARCHIVE,
            ALWAYS_SECTOR_TEMPLATE,
            load(ALWAYS_SECTOR_RAW),
        ),
        (
            SECURITY_SECTOR_RAW,
            SECURITY_SECTOR_ARCHIVE,
