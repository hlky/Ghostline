...
def generate_journal() -> dict[str, Any]:
    ...
    for index, suffix, _, marker in OBJECTIVES:
        ...
        objective["Data"]["description"] = loc(f"gl_gqt003_0{index}_objective_{suffix}")
        ...
        if marker:
            ...
            for marker_index, marker_ref in enumerate(markers, start=1):
                ...
                pin_suffix = (
                    f"escort_gate_0{marker_index}" if len(markers) > 1 else suffix
                )
                ...
                pin["Data"]["mappinData"]["localizedCaption"] = loc("gl_gqt003_mappin")
                pins.append(pin)
...
def generate_timed_defend() -> dict[str, Any]:
    ...
    success_quest = quest_completion_node(builder, 23, "quests/minor_quest/gqt003")
    ...
    failure_quest = quest_completion_node(builder, 27, "quests/minor_quest/gqt003")
