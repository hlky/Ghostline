...
OBJECTIVES = (
    ...
    (
        3,
        "drive_contact",
        "Drive to the first test point.",
        "#gqt004_03_mp_ride_destination",
    ),
    (
        4,
        "steal_vehicle",
        "Take the designated test vehicle.",
        "#gqt004_04_mp_theft_vehicle",
    ),
    (
        5,
        "deliver_vehicle",
        "Deliver the test vehicle.",
        "#gqt004_05_mp_theft_destination",
    ),
)
...
def generate_journal() -> dict[str, Any]:
    ...
    for index, suffix, _, marker in OBJECTIVES:
        ...
        objective["Data"]["description"] = loc(f"gl_gqt004_0{index}_objective_{suffix}")
        ...
        if marker:
            ...
            pin["Data"]["mappinData"]["localizedCaption"] = loc("gl_gqt004_mappin")
...
def generate_final_cleanup() -> dict[str, Any]:
    ...
    quest_done = quest_completion_node(builder, 12, "quests/minor_quest/gqt004")
