...
INSTANCE_PATCH_ARCHIVE = (
    ROOT / "source/archive/mod/gqt001/world" / "gqt001_laptop_instance.streamingsector"
)
BLOCK_RAW = (
    ROOT / "source/raw/mod/gqt001/world" / "gqt001_signal_delay.streamingblock.json"
)
BLOCK_ARCHIVE = (
    ROOT / "source/archive/mod/gqt001/world" / "gqt001_signal_delay.streamingblock"
)
DEVICE_REGISTRY_RAW = (
    ROOT / "source/raw/mod/gqt001/world" / "gqt001_custom_devices.devices.json"
)
...
DOCUMENT_PATH = "onscreens/emails/quests/minor_quest/gqt001/files/diagnostic"
...
def generate_journal() -> dict[str, Any]:
    ...
    for index, suffix in ((1, "reach_terminal"), (2, "read_diagnostic")):
        ...
        objective["Data"]["description"] = loc(f"gl_gqt001_0{index}_objective_{suffix}")
        ...
        if index == 1:
            ...
            pin["Data"]["reference"]["reference"]["$value"] = "#gqt001_01_mp_terminal"
            pin["Data"]["mappinData"]["debugCaption"] = "gl_gqt001_01_mappin_terminal"
    ...
    file_group_template = find_entry(source_files, "gameJournalFileGroup", "files")
    file_template = next(
        item
    ...
    poi["Data"]["questPath"]["Data"]["realPath"] = "quests/minor_quest/gqt001"
