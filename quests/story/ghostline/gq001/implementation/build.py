...
ONSCREEN_TEMPLATE = (
    ROOT / "source/raw/mod/gq000/localization/en-us/onscreens/gq000.json.json"
)
...
ONSCREEN_ARCHIVE = (
    ROOT / "source/archive/mod/gq001/localization/en-us/onscreens/gq001.json"
)
...
def generate_journal() -> dict[str, Any]:
    journal = rewrite(
        load(JOURNAL_TEMPLATE), lambda text: text.replace("gq000", "gq001")
    )
